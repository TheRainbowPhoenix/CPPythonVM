...
extern "C" void main() {
  ...
  // // Example for Debug_Printf(x,y,invert_color,0,format_string) //(small
  // text) Debug_Printf(0, 1, false, 0, "%d", c); Debug_Printf(0, 2, false, 0,
  // "%d", sc); Debug_Printf(0, 3, false, 0, "%d", uc); Debug_Printf(0, 4,
  // false, 0, "%d", s); Debug_Printf(0, 5, false, 0, "%u", us); Debug_Printf(0,
  // 6, false, 0, "%d", i); Debug_Printf(0, 7, false, 0, "%u", ui);
