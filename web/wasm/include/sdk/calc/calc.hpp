...
extern "C" void setPixel(int x,int y, uint32_t color);

extern "C" void line(int x1, int y1, int x2, int y2, uint16_t color);

extern "C" void triangle(int x0, int y0, int x1, int y1, int x2, int y2, uint16_t colorFill, uint16_t colorLine);

extern "C" void vline(int x, int y1, int y2, uint16_t color);


extern "C" void fillScreen(uint16_t color);
